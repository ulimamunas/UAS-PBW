    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="inputberita.php" class="active">
        ...
        <div>
          <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            <div class="form-floating mb-3">
              <input id="uname" type="text" class="form-control" name="judul">
          ...
          <?php
              if (isset($_POST['buat'])) {
                ...
                $isi = $_POST['isi'];
                $edit=  mysqli_query($conn, "INSERT INTO berita SET judul='$name_berita',id_kategori='$ctg',isi='$isi'");
                if($edit){

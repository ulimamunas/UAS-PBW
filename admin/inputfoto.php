    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tambahkanfoto.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambahkan Foto</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div>
          <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center">
              <button type="submit" name="buat" class="btn btn-primary">Tambahkan Foto</button>
            </div>
          ...
          <?php
              if (isset($_POST['buat'])) {
                ...
                $edit=  mysqli_query($conn, "INSERT INTO foto SET foto='$foto'");
                if($edit){

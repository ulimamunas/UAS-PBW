    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="kelolaberita.php" class="active">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="inputfoto.php">
              <i class="bi bi-circle"></i><span>Tambahkan Foto</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                  ...
                  <a href="deleteberita.php?id=<?= $row['id'];?>" class="btn btn-danger btn-sm">Hapus</a>
                </td>
              </tr>
              <!-- Modal -->
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="modal-body">
                        <div class="form-floating mb-3">
                          ...
                          <input id="uname" type="text" class="form-control" name="judul" value="<?= $row['judul']?>">
                        ...
                        <div class="form-floating mb-3">
                          <input id="kategori" type="text" class="form-control" name="id_kategori"
                            value="<?= $row['id_kategori']?>">
                          <label for="kategori">Kategori Berita:</label>
                        </div>
                        <div class="form-floating mb-3">
                          <textarea class="form-control" placeholder="Isi Berita" name="isi"
                            style="height: 100px;"><?= $row['isi']?></textarea>
              ...
              if(isset($_POST['simpan'])){
                $id = $_POST['id'];
                $name_berita = $_POST['judul'];
                $ctg = $_POST['id_kategori'];
                $isi = $_POST['isi'];
                $edit=  mysqli_query($conn, "UPDATE berita SET judul='$name_berita',id_kategori='$ctg',isi='$isi' WHERE id='$id'");
                if($edit){
                  move_uploaded_file($file_tmp, '../assets/images/'.$foto);
                  echo '<script> window.addEventListener("load",function (){window.location.href=window.location.href;},false); </script>';
                }
              }
              ?>
            </tbody>

    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="kelolafoto.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Kelola Foto</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="../assets/img/fotogemas/<?=$row['foto']?>"
            ...
            <td><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
              ...
              <a href="deletefoto.php?id=<?= $row['id'];?>" class="btn btn-danger btn-sm">Hapus</a>
            </td>
          </tr>
          <!-- Modal -->
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="editModalLabel<?= $i;?>">Edit Foto</h1>

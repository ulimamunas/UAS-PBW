    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="kelolakomentar.php" class="active">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                    ...
                    <a href="deletekomentar.php?id=<?= $row['id'];?>" class="btn btn-danger btn-sm">Hapus</a>
                  </td>
                </tr>
                <!-- Modal -->
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-5" id="editModalLabel<?= $i;?>">Edit Komentar</h1>
                      ...
                      <form action="" method="POST">
                        <div class="modal-body">
                          ...
                          <div class="form-floating mb-3">
                            <input id="message" type="message" name="message" class="form-control">
                ...
                if(isset($_POST['simpan'])){
                  $id = $_POST['id'                                     ];
                  $email = $_POST['email'];
                  $pw = mysqli_real_escape_string($conn,$_POST['message']);
                  $pw = md5($pw);

                  $edit=  mysqli_query($conn, "UPDATE aduan SET name='$name',email='$email',message='$message' WHERE id='$id'");
                  if($edit){

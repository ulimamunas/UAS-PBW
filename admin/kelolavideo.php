    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="kelolavideo.php" class="active">
          ...
          <table>
            ...
            <tr>
              ...
              <td><button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                ...
                <a href="deletevideo.php?id=<?= $row['id'];?>" class="btn btn-danger btn-sm">Hapus</a>
              </td>
            </tr>
            <!-- Modal -->
                ...
                <div class="modal-content">
                  ...
                  <form action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                      <input type="number" name="id_video" class="d-none" value="<?= $row['id']?>">
                      <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="Deskripsi Produk" name="link_video"
                          style="height: 100px;"><?= $row['link_video']?></textarea>
            ...
            if(isset($_POST['simpan'])){
              ...
              $edit=  mysqli_query($conn, "UPDATE video SET link_video='$link' WHERE id='$id'");
              if($edit){

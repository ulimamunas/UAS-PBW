...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="indexuser.php">Desa Karangjati</a></h1>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#about">About</a></li>
          <li class="dropdown"><a href="#foto"><span>Gallery</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li class="dropdown"><a href="#pengaduan"><span>Speak Up</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Tentang Desa Karangjati</h3>
            <p>
              Desa Karangjati terletak di Kecamatan Wonosegoro, Kabupaten Boyolali, Provinsi Jawa Tengah. Memiliki
    ...
    <section id="foto" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Foto</h2>
          <p>Kumpulan foto gemas dari Desa Karangjati</p>
        </div>
        <?php
    ...
    <section id="video" class="container">
      <div class="section-title">
        <h2>Video</h2>
        <p>Kumpulan video gemas dari Desa Karangjati</p>
      </div>
    ...
    <section id="product" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Product</h2>
          <p>Macam-macam product yang dijual oleh Desa Karangjati, langsung hubungi nomor yang tertera!</p>
        </div>
    ...
    <section id="pengaduan" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Pengaduan</h2>
          <p>Silakan Log In untuk mengisi kolom Pengaduan</p>
        </div>
    ...
    <section id="komentar" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Silakan Log In untuk mengisi kolom Komentar</p>
        </div>
